...
@section('page-description', 'إضافة معلم للمدرسة')
...
<div class="bg-white rounded-2xl shadow-sm border border-gray-100">
    ...
    <form action="{{ route('admin.teachers.store') }}" method="POST" class="p-6" id="teacherForm">
        @csrf
        ...
        <div class="flex items-center gap-4 pt-6 border-t">
            <button type="submit" class="px-6 py-3 bg-indigo-600 text-white rounded-xl hover:bg-indigo-700 transition">
                <i class="fas fa-save ml-2"></i>حفظ المعلم
            </button>
...
<script>
    ...
    document.getElementById('teacherForm').addEventListener('submit', function(e) {
        ...
        // جمع كل التعيينات
        const assignmentContainers = document.querySelectorAll('[data-assignment-container]');
